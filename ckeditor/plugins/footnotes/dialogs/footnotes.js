    ...
    CKEDITOR.dialog.add( 'footnotesDialog', function( editor ) {
        ...
        return {
                            ...
                            setup: function( element ) {
                                ...
                                if ($footnotes.length > 0) {
                                    ...
                                    $footnotes.find('li').each(function(){
                                        ...
                                        radios += '<li style="margin-left: 15px;"><input type="radio" name="footnote_id" value="' + footnote_id + '" id="fn_' + footnote_id + '" /> <label for="fn_' + footnote_id + '" style="white-space: normal; display: inline-block; padding: 0 0 0 5px; vertical-align: top; margin-bottom: 10px; width: calc(100% - 25px);">' + $item.find('cite').text() + '</label></li>';
                                    });
            ...
            onShow: function() {
                ...
                jQuery('.cke_dialog_contents').css({'max-height': '86vh', 'overflow-y': 'auto', 'padding': 0, 'display': 'block'});
                ...
                CKEDITOR.replaceAll( function( textarea, config ) {
                    ...
                    config.allowedContent = 'p br em strong i b; a[!href]';
            ...
            onOk: function() {
                ...
                var footnote_data   = footnote_editor.getData().replace(/^<p>/, '').replace(/<\/p>/, '');
