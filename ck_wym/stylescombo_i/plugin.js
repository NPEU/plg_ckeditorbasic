 ...
 */
console.log('Loading `stylescombo_i`...');
( function() {
	'use strict';

	CKEDITOR.plugins.add( 'stylescombo_i', {
		requires: 'richcombo',
		lang: 'af,ar,bg,bn,bs,ca,cs,cy,da,de,el,en,en-au,en-ca,en-gb,eo,es,et,eu,fa,fi,fo,fr,fr-ca,gl,gu,he,hi,hr,hu,id,is,it,ja,ka,km,ko,ku,lt,lv,mk,mn,ms,nb,nl,no,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sr,sr-latn,sv,th,tr,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%

		init: function( editor ) {
			var config = editor.config,
				lang = editor.lang.stylescombo_i,
				styles = {},
				stylesList = [],
				combo,
				allowedContent = [];
			...
			editor.on( 'stylesSet', function( evt ) {
                var stylesDefinitions = CKEDITOR.stylesSet.get('inline_styles');
			...
			editor.ui.addRichCombo( 'Styles--I', {
				label: lang.label,
